...
Scenario:	NHSERS-111_S016_C2B |Patient be able to login with correct login details after 2x failed login attempts within 25 minutes
...
!-- And has 2x failed login attempts already within 25 minutes
Given the failed login count for ubrn "<ubrnno>" is 2
!-- When they submit their correct <login details> on the login page within 25 minutes of first failed login
!-- When the user waits 25 minutes // Within 25 mins
...
|Login|e-Referral Service|1110 0000 0016|111000000016|1971|WrongPass|Password01|
